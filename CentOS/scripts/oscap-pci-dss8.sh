...
# oscap xccdf eval --profile xccdf_org.ssgproject.content_profile_standard --fetch-remote-resources --remediate /usr/share/xml/scap/ssg/content/ssg-centos8-ds.xml || true
# oscap xccdf eval --profile xccdf_org.ssgproject.content_profile_standard --fetch-remote-resources --remediate /usr/share/xml/scap/ssg/content/ssg-rhel8-ds.xml || true
